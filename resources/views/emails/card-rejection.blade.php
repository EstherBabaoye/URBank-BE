...
<head>
  <meta charset="UTF-8">
  <title>URBank Card Rejection</title>
</head>
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background-color:#f4f4f4;">
  <div style="max-width:600px;margin:0 auto;background:white;border-radius:8px;overflow:hidden;">
    ...
    <div style="padding:30px; color:#051d40; font-size:15px; line-height:1.6;">
      ...
      <p>Your <strong>URBank</strong> card application has been <strong>rejected</strong>.</p>

      <p>Please double-check your submitted details and documents. You may try again at a later time.</p>

      <p>We’re here to help – feel free to reach out if you have any questions.</p>

      <p>Regards,<br><strong>URBank Team</strong></p>
    </div>
