...
<head>
  <meta charset="UTF-8">
  <title>URBank Contact Acknowledgment</title>
</head>
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background-color:#f4f4f4;">
  <div style="max-width:600px;margin:0 auto;background:white;border-radius:8px;overflow:hidden;">
    ...
    <div style="padding:30px; color:#051d40; font-size:15px; line-height:1.6;">
      ...
      <p>Thank you for contacting <strong>URBank</strong>. We have received your message and our support team will get back to you within 24–48 hours.</p>

      <p><strong>Your message:</strong></p>
      <blockquote style="margin: 1em 0; padding-left: 15px; border-left: 3px solid #ccc;">
        {!! nl2br(e($userMessage)) !!}
      </blockquote>

      <p>Warm regards,<br><strong>URBank Support Team</strong></p>
    </div>
